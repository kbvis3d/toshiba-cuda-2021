...
<head>
    ...
    <title>04-page-faults-solution-gpu-then-cpu.cu (editing)</title>
...
data-base-url="/lab/"
data-file-path="06-unified-memory-page-faults/solutions/04-page-faults-solution-gpu-then-cpu.cu"
